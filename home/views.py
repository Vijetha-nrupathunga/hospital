...
def createbill(request):
    if request.method=='POST':
        ...
        if form.is_valid():
            ...
            return render(request,'create.html',{'form':form,'value':'BILL'})
    else:
        form=billform()
        return render(request,'create.html',{'form':form,'value':'BILL'})
...
def patientpage(request,name):
    ...
    tem='/patient/'+name
    print(tem)
    return render(request, 'Ppage.html', {'form':form,'temp':temp,'tem':tem})
...
def TokenT(request,name):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return render(request,'Rtoken.html',{'form':result,'count':countt,'temph':temph})
    else:
        form=Token()
        temp=doctor.objects.all()
        
    return render(request, 'Ftoken.html', {'form': form,'temp':temp})
...
def createreport(request):
    if request.method=='POST':
        ...
        if form.is_valid():
            ...
            return render(request,'create.html',{'form':form,'value':'REPORT'})
    else:
        form=reportform()
        return render(request,'create.html',{'form':form,'value':'REPORT'})
